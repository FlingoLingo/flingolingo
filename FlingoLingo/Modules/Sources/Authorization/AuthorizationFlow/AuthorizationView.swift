...
extension AuthorizationView {
    ...
    private func setupNavigationBarConstraints() {
        NSLayoutConstraint.activate([
            ...
            navigationBarBackButton.leadingAnchor.constraint(equalTo: navigationBarView.leadingAnchor, constant: CommonConstants.bigSpacing),
            ...
            navigationBarTitleLabel.leadingAnchor.constraint(equalTo: navigationBarBackButton.trailingAnchor, constant: CommonConstants.smallSpacing),
    ...
    private func setupDescriptionLabelConstraints() {
        NSLayoutConstraint.activate([
            descriptionLabel.topAnchor.constraint(equalTo: navigationBarView.bottomAnchor, constant: CommonConstants.smallSpacing),
